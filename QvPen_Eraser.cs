...
namespace QvPen.UdonScript
{
    ...
    public class QvPen_Eraser : UdonSharpBehaviour
    {
        ...
        public void _Init(QvPen_EraserManager manager)
        {
            ...
            // normal = meshRenderer.materials[0];
            // erasing = meshRenderer.materials[1];
        ...
        public void OnPickupEvent() =>  meshRenderer.materials[0].color = normal.color;

        public void OnDropEvent() =>   meshRenderer.materials[0].color = normal.color;
        ...
        {
            isErasing = true;
            meshRenderer.materials[0].color = erasing.color;
            // if collider enters another collider play sound
            // if the collider this object is on detects a collion on anoother colider, play sond
            // renderer.sharedMaterial = erasing;
            // play audio
            ...
            //     audioSource.Play();
            // }
            // gameObject.GetComponent<MeshRenderer>().materials[0] = erasing;

        }

        // void OnTriggerEnter(Collider other)
        // {
        //     if (isErasing && other.gameObject.layer == inkColliderLayer)
        //     {
        //         if (audioSource != null && !audioSource.isPlaying)
        //         {
        //             audioSource.Play();
        ...
        {
            isErasing = false;
            meshRenderer.materials[0].color = normal.color;
            ...
            //     audioSource.Stop();
            // }
            // gameObject.GetComponent<MeshRenderer>().materials[0] = normal;
            // renderer.sharedMaterial = normal;
        }
